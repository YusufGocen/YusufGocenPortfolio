      ...
      <motion.div
        ...
        <motion.div
          ...
          className='project-card'>
            <div className='project-image' style={{backgroundImage:"url('/Projects/NöbetciEczane.png')"}}  whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}/>
        ...
        <motion.div
          ...
          whileHover={{ y: -10, transition: { duration: 0.2 } }}
          className='project-card'>
            <div className='project-image' style={{backgroundImage:"url('/Projects/TwitterClone.png')"}}  whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}/>
        ...
        <motion.div
          ...
          whileHover={{ y: -10, transition: { duration: 0.2 } }}
          className='project-card'>
            <div className='project-image' style={{backgroundImage:"url('/Projects/CaveHotel.png')"}}  whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}/>
        ...
        <motion.div
          ...
          whileHover={{ y: -10, transition: { duration: 0.2 } }}
          className='project-card'>
            <div className='project-image' style={{backgroundImage:"url('/Projects/LifeFitness.png')"}}  whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}/>
              <h3>Life Fitness</h3>
              <p>
         ...
         <motion.div
          ...
          whileHover={{ y: -10, transition: { duration: 0.2 } }}
          className='project-card'>
            <div className='project-image' style={{backgroundImage:"url('/Projects/css-gradiant.png')"}}  whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}/>
        ...
        <motion.div
          ...
          whileHover={{ y: -10, transition: { duration: 0.2 } }}
          className='project-card'>
            <div className='project-image' style={{backgroundImage:"url('/Projects/WeatherApp1.png')"}}  whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}/>
              <h3>Hava Durumu</h3>
              <p>
